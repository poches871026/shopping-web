package com.majestic.shoppingweb.config;


import com.majestic.shoppingweb.interceptor.RequestResponseLoggingInterceptor;
...
public class RestTemplateConfig {
    ...
    public RestTemplate restTemplate(RestTemplateBuilder restTemplateBuilder) {
        ...
        return restTemplateBuilder
                ...
                .setConnectTimeout(Duration.ofMillis(5000000)) //읽기시간초과, ms
                .setReadTimeout(Duration.ofMillis(5000000))    //연결시간초과, ms
